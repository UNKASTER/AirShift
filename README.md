...
- 当前执勤页显示正在执行任务的到位倒计时（进港：实时到达前 10 分钟；仅出港：实时起飞前 1 小时）、登机口/机位变更的新旧值对比、出港预计登机开始（起飞前 40 分钟）与预计登机口关闭（起飞前 15 分钟，均以实际起飞时间为准回退预计/计划）、完整特服详情；执勤完成按钮按日推进任务进度，进度存于本机并随新排班导入重置。
